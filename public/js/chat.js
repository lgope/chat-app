...
// Options
const { username, room } = Qs.parse(location.search, { ignoreQueryPrefix: true }); // This going to create an object with two properties (one would be room and other would be a question mark user name) and ignoreQueryPrefix: true for remove other symbol's like (question mark ?)
