...
io.on("connection", socket => {
    ...
    socket.on("join", (options, callback) => {
        ...
        // When a user join
        socket.broadcast.to(user.room).emit("message", generateMessage('Admin', `${user.username} has joined!`)); // I used socket.broadcast.emit to emit it to everybody but that particular connection
